...
1. Clone this repository `git clone https://github.com/listless/Project-Euler-in-Rust.git`
2. cd into the directory `cd Project-Euler-in-Rust`
...
- [Rust](http://www.rust-lang.org/ "Rust's Official Website")

>Rust is a curly-brace, block-structured expression language. It visually resembles the C language family, but differs significantly in syntactic and semantic details. Its design is oriented toward concerns of gprogramming in the largeh, that is, of creating and maintaining boundaries ? both abstract and operational ? that preserve large-system  integrity, availability and concurrency. 
